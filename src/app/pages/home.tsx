  ...
  return (
    ...
    >
      ...
      <main
        ...
        className={`
          grid content-center
          data-has-posts:min-h-[50svh]
        `}
      >
        <div
          className={`
            grid grid-flow-col grid-cols-[auto_max-content]
            grid-rows-[repeat(2,_max-content)] items-center gap-x-10 gap-y-1
          `}
        >
          ...
          <img
            ...
            className={`
              ...
              [@media_(min-width:445px)]:row-span-full
            `}
          />
        </div>
        ...
        <aside
          className={`
            mt-6 flex flex-row flex-wrap gap-x-6 gap-y-2 font-semibold
            text-neutral-800
        ...
        {Boolean(posts.length) && (
          <section className="mt-24">
            <h2
              className={`
                text-xl font-semibold text-neutral-600
                dark:text-neutral-400
              `}
            >
              Posts
